          ...
          <div className="max-w-md space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-indigo-500/20 border border-indigo-500/30 rounded-full">
                ...
                <span className="text-sm text-indigo-300">AI-Powered Analytics Platform</span>
              </div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Unlock the power of AI-driven analytics. Make data-driven decisions faster with intelligent insights and beautiful visualizations.
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      className="w-4 h-4 rounded border-[#2a2a3e] bg-[#0f0f23] text-indigo-600 focus:ring-indigo-500"
                    />
