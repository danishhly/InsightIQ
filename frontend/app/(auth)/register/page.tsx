        ...
        >
          ...
          <div className="space-y-1 mb-6">
            ...
            <p className="text-sm" style={{ color: 'hsl(215, 20%, 65%)' }}>
              Get started with InsightIQ today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={(e) => {
                    e.target.style.borderColor = 'hsl(220, 20%, 18%)';
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-10 px-4 py-2 rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              style={{
                background: 'linear-gradient(135deg, hsl(217, 91%, 60%) 0%, hsl(199, 89%, 48%) 50%, hsl(180, 100%, 50%) 100%)',
                color: 'hsl(220, 26%, 6%)',
                boxShadow: '0 0 60px hsl(199, 89%, 48% / 0.3)',
